        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6" staggerDelay={0.12}>
          {TESTIMONIALS.map((t, i) => (
            <StaggerItem key={t.name}>
              <div
                className={`group flex flex-col p-8 rounded-3xl bg-card border border-border h-full shadow-elevated transition-all duration-300 hover:scale-[1.02] hover:shadow-xl ${
